...
function nuevoUsuario(nombre, email, password) {
  ...
  // Devuelve el objeto
  // Tu código:
  var objetoNuevo = { nombre: nombre, email:email, password:password};
  return objetoNuevo;
}
...
function actualizarPassword(usuario, nuevaPassword) {
  // Reemplaza la contraseña existente en la propiedad "password" en el objeto "usuario" con el valor de "nuevaPassword"
  // Devuelve el objeto
  // Tu código:
